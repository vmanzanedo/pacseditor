...
<table id="listaestudio" class="table table-dark table-striped table-hover">
	...
	<td>
        ...
        <td>
          <button type="button" class="btn btn-success btn-sm " data-pk="<?php echo $reg['patient_pk'] ?>" data-paciente_nombre="<?php echo utf8_encode($reg['pat_name']) ?>" data-paciente_dni="<?php echo $reg['pat_id'] ?>"  data-fecha_nacimiento="<?php echo $reg['pat_birthdate'] ?>" data-paciente_sexo="<?php echo $reg['pat_sex'] ?>" data-study_iuid="<?php echo $reg['study_iuid'] ?>" data-pat_id_issuer="<?php echo $reg['pat_id_issuer'] ?>" data-toggle="modal" data-entidad="pacseditor" data-target="#modal" data-op="1" title="Paciente"><i class="fa fa-user" aria-hidden="true"></i></button>          
          <button type="button" class="btn btn-success btn-sm" data-pk="<?php echo $reg['patient_pk'] ?>" data-paciente_nombre="<?php echo utf8_encode($reg['pat_name']) ?>" data-paciente_dni="<?php echo $reg['pat_id'] ?>"  data-fecha_nacimiento="<?php echo $reg['pat_birthdate'] ?>" data-paciente_sexo="<?php echo $reg['pat_sex'] ?>" data-study_iuid="<?php echo $reg['study_iuid'] ?>" data-pat_id_issuer="<?php echo $reg['pat_id_issuer'] ?>" data-toggle="modal" data-entidad="pacseditor" data-target="#modal" data-op="2" title="DNI"><i class="fa fa-address-card" aria-hidden="true"></i></button>          
          ...
          <button type="button" class="btn btn-success btn-sm" data-studyuid="<?php echo $reg['study_iuid'] ?>" data-study_desc="<?php echo utf8_encode($reg['study_desc'])?>" data-toggle="modal" data-entidad="pacseditor_studydesc" data-target="#modal" data-op="1" title="Study_desc"><i class="fa fa-list-alt" aria-hidden="true"></i></button>          
        </td>
        <td>
